...
from film20.recommendations.synopsis_helper import EnglishWikipediaSynopsisFetcher
...
class WikipediaFetcherTestCase(TestCase):
    ...
    def test_fetcher(self):
        ...
        urls = fetcher.get_movie_urls(title, year)
        titles = fetcher.get_movie_title(title, year)
        print titles
        synopses = fetcher.get_movie_synopses(titles[0])
