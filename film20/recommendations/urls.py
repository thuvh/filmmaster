...
recompatterns = patterns('',
    ...
    ### RANKING ###
    url(r'^'+urls["RANKING"]+'/$', ranking_view, name='rankings'),
    url(r'^'+urls["RANKING"]+"/(?P<type_as_str>['\w\-_]+)/$", ranking_view, name='rankings'),
    url(r'^'+urls["RANKING"]+'/'+urls['GENRE']+ genre, ranking_view, name='rankings_menu'),
