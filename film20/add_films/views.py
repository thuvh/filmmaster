...
from film20.add_films.utils import clear_actors_cache
from film20.core.models import Country, Person, Character
...
def ajax_person_list( request ):
    ...
    if search_results is not None:
        ...
        out = '\n'.join( map( lambda o:format_person_row( o ), list( best_results ) + list( results ) ) )
    else:
        out = ''
