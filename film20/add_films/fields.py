...
class DirectorsWidget( widgets.Widget ):
    ...
    $('document').ready(function () {
        ...
        // --- sortable
        //$(".directors_content").sortable({handle : '.handle', items: '.row-d' });
    ...
    HTML_ROW = [
        '<div class="row-d">',
            ...
            '<img src="/media/img/admin/icon_addlink.gif" width="10" height="10" alt="[+]"/></a>',
    ...
    def render( self, name, value, attrs=None ):
        ...
        output.append( u'</div><a id="add_%s" href="javascript:void(0);" class="add_director"><img src="/media/img/admin/icon_addlink.gif" width="10" height="10" alt="[+]"/> %s</a><div style="clear:both"></div>' % ( name, _( "add director" ) ) )
...
class ActorsWidget( widgets.Widget ):
    ...
    $('document').ready(function () {
        ...
        // --- sortable
        //$(".actors_content").sortable({handle : '.handle', items: '.row' });
    ...
    def render( self, name, value, attrs=None ):
        ...
        output.append( u'</div><a id="add_%s" href="javascript:void(0);" class="add_actor"><img src="/media/img/admin/icon_addlink.gif" width="10" height="10" alt="[+]"/> %s</a>' % ( name, _( "add actor" ) ) )
