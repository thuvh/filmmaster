...
COUNTRIES_WITH_SHOWTIMES = ('US', 'GB', 'PL')
...
CACHE_PREFIXES = {
    ...
    "town_channels": opt(A_DAY),
    "town_cinemas": opt(A_DAY),
    "country_cinemas": opt(A_DAY),
    "country_towns": opt(A_DAY, version=1),
    "country_tv": opt(A_DAY),
    "checkins": opt(A_DAY),
...
NOTIFICATION_FORCE_SITE_LANG = True
...
RANKING_MIN_NUM_VOTES_FILM = 30
RANKING_MIN_NUM_VOTES_OTHER = 15
...
MAX_CHARACTERS_SHORT_REVIEW = 500
...
BLOG_FEED = 'http://blog.%(DOMAIN)s/feed/'
