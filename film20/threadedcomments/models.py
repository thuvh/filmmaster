...
class ThreadedComment(Object):
    ...
    def delete(self, **kwargs):
         if hasattr(self.content_object, 'number_of_comments') and self.content_object.number_of_comments:
            self.content_object.number_of_comments -= 1
    ...
    def save(self, **kwargs):
        ...
        if self.pk == None:
            if self.content_object.number_of_comments:
                self.content_object.number_of_comments += 1
                self.content_object.save()
            else:
                self.content_object.number_of_comments = 1
