...
from film20.core.models import Recommendation, Rating, Film, FilmRanking
...
class ScreeningSet(BaseScreeningSet):
    ...
    def _get_recommendations(self):
        ...
        if self.user and self.user.is_authenticated():
            ...
            if profile.recommendations_status in (profile.NORMAL_RECOMMENDATIONS, profile.FAST_RECOMMENDATIONS):
                recommendations = _user_film_recommendations(self.user, film_ids)
            else:
                recommendations = {}
