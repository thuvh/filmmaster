...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_profile', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True, null=True), keep_default=False)
         
    def backwards(self, orm):

        # Deleting field 'Profile.display_name'
        db.delete_column('core_profile', 'display_name')
    ...
    models = {
        ...
        'core.profile': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'unique': 'True', 'null': 'True'}),
