...
def initialize_server_request(request):
    ...
    ctype = request.META.get('CONTENT_TYPE', None) or \
            request.META.get('HTTP_CONTENT_TYPE', None) or type_formencoded

    if request.method in ('POST', 'PUT') and ctype == type_formencoded:
